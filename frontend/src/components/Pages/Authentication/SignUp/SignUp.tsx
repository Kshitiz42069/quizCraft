        ...
        <div className='bg-[#C0C9EE] w-1/2 h-full pl-[4rem]'>
            ...
            <div className=' bg-[#E0E5FB] w-8/9 h-[45vh] p-4 flex flex-col  gap-4 justify-around my-[4rem] rounded-2xl'>
                <form action="submit" onSubmit={handleSubmit} method="post" className='flex gap-8 flex-wrap'>
                    <label htmlFor="name" className='flex flex-col gap-[1rem] w-[15rem]'>
                    ...
                    <label htmlFor="email" className='flex flex-col gap-[1rem] w-[15rem]'>
                    ...
                    <label htmlFor="password" className='flex flex-col gap-[1rem] w-[15rem]'>
                    ...
                    <div className='flex w-full justify-evenly items-center'>
                        ...
                        <button type="submit" className='bg-[#898AC4] p-1 rounded-2xl text-[#E0E5FB] w-[15rem] cursor-pointer'>
